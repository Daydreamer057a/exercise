...
public class TestMoneyTransfer {
    ...
    public void setUp(TestContext context) throws IOException {
        ...
        vertx.deployVerticle(Main.class.getName(), options, context.asyncAssertSuccess());
    }
    ...
    public void accountWithdraw_InsufficientFunds() {
        put("/accounts/1/withdraw/10000000").then()
            .assertThat()
            .statusCode(403);
    }
    ...
    public void accountWithdraw() {
        put("/accounts/1/withdraw/10").then()
            .assertThat()
            .statusCode(200);
    }
    ...
    public void accountOperationOtherThanDepositOrWithdrawNotAllowed() {
        put("/accounts/1/paySomeOne/10").then()
            .assertThat()
            .statusCode(404);
    }
